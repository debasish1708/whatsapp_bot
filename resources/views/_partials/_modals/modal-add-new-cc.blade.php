  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h5 class="modal-title" id="addNewCCModalLabel">{{ __('Import Students') }}</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>

      <!-- Modal Body -->
      <div class="modal-body">
        <form id="importStudentForm" method="POST" action="{{ route('school.students.import') }}" enctype="multipart/form-data">
          @csrf
          <div class="mb-3">

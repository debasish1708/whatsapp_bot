        ...
        <div class="col-md-12 col-lg-12">
          <div class="card text-center">
            <div class="card-body">
              ...
              <h4 class="mb-3">{{ $lang=='cs' ? 'Platba úspěšná' : 'Payment Successful' }} 🎉</h4>
              <p class="mb-4">{{ $lang=='cs' ? 'Děkujeme za vaši platbu za přijetí. Úspěšně jsme obdrželi vaši platbu.' :
              'Thank you for your admission payment. We’ve successfully received your payment.' }}</p>
              <a href="https://wa.me/{{config('constant.360dialog_whatsapp_number')}}" class="btn btn-success" target="_blank">
                {{ $lang=='cs' ? 'Otevřete WhatsApp' : 'Open WhatsApp' }}
              </a>

<div class="d-flex align-items-center gap-2">
  ...
  <!-- Edit Icon -->
  <button type="button" class="p-0 border-0 bg-transparent" onclick="handleEditJobOffer('{{ $user->user_id }}')"
    title="Edit">
  ...
  <button type="button" class="p-0 border-0 bg-transparent" data-bs-toggle="modal"
    onclick="deleteItem('{{ route('school.students.destroy',$user->user_id) }}')"  title="Delete">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form action="{{ route('school.job-offer.destroy', $user->user_id) }}" method="post" class="m-0 d-inline">
                        @csrf
                        @method('DELETE')

...
@section('content')
  ...
  <div class="row">
    ...
    <div class="col-xxl">
    <div class="card mb-6">
      <h4 class="card-header">Edit Psychological Support</h4>
      <form id="formAuthentication" class="card-body" action="{{ route('school.psychological-support.update', $psychologicalSupport->id) }}"
      ...
      <div class="row mb-6">
        ...
        <input type="text" id="name" name="name" class="form-control" placeholder="Enter Psychological Support Name"
          value="{{ $psychologicalSupport->name }}" />
        </div>
      ...
      <div class="row mb-6">
        ...
        <input type="text" id="mobile_number" name="mobile_number" class="form-control"
          placeholder="Enter Mobile Number" value="{{ $psychologicalSupport->mobile_number  }}" />
        </div>
      ...
      <input type="text" class="form-control flatpickr-time1" placeholder="Start Time"
        ...
        value="{{ old("office_hours.$key.start_time", $office_hours[$key]['start_time']  ?? '') }}" />
      ...
      <input type="text" class="form-control flatpickr-time1" placeholder="End Time"
        ...
        value="{{ old("office_hours.$key.end_time", $office_hours[$key]['end_time'] ?? '') }}" />
      ...
      @php
        $isClosed = old("office_hours.$key.is_closed", default: $office_hours[$key]['is_closed'] ?? null);
      @endphp
      <div class="col-sm-3">
      <div class="d-flex align-items-center gap-2">
        <input class="form-check-input" type="checkbox" id="is_closed_{{ $key }}"
        name="office_hours[{{ $key }}][is_closed]" value="1"  {{ is_null($isClosed) || $isClosed ? 'checked' : '' }} />
    ...
    @endforeach
      ...
      <div class="pt-6">
        ...
        <div class="w-100 mb-3 d-flex align-items-center justify-content-center">
          <button type="submit" class="btn btn-primary me-4">Update Psychological Support</button>
        </div>
        </div>
      </div>
      </form>

...
<script>
  function handleStatusButtons(url, type){
    ...
    let message=type=='approve' ? 'Are you sure you want to approve the deletion request?' : 'Are you sure you want to reject the deletion request?';
...
<div class="w-100 d-flex align-items-center justify-content-between mb-4">
    ...
    <div class="d-flex gap-2">
        @if($restaurant->is_profile_completed && $account->status == 'pending')
            <!-- Full Approve Button -->
    ...
    <div class="card mb-6">
      <div class="card-body">
        ...
        <ul class="list-unstyled my-3 py-1">
          <li class="d-flex align-items-center mb-4"><i class="ti ti-user ti-lg"></i><span class="fw-medium mx-2">Restaurant Name:</span> <span>{{$account->name ?? ''}}</span></li>
          ...
          @if($restaurant->sustainabilities)
            @foreach(collect(json_decode($restaurant->sustainabilities))->toArray() as $sustainability)
              ...
              <span class="badge bg-primary-subtle text-primary rounded-pill px-3 py-2">
                <i class="ti ti-check me-1"></i> {{$sustainability}}
              </span>
            @endforeach
          @else

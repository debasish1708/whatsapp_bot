...
<div class="w-100 d-flex align-items-center justify-content-between mb-4">
    ...
    <div class="d-flex gap-2">
        @if($school->is_profile_completed && $account->status == 'pending')
            <!-- Full Approve Button -->
            <a href="javascript:void(0)" onclick="handleStatusButtons('{{route('accounts.delete-request.accept', $account->id)}}', 'approve')"
               class="btn btn-success">
                Approve
            </a>

            <!-- Full Reject Button -->
            <a href="javascript:void(0)" onclick="handleStatusButtons('{{route('accounts.delete-request.reject', $account->id)}}', 'reject')"
    ...
    <div class="card mb-6">
      <div class="card-body">
        ...
        <ul class="list-unstyled my-3 py-1">
          <li class="d-flex align-items-center mb-4"><i class="ti ti-user ti-lg"></i><span class="fw-medium mx-2">School Name:</span> <span>{{$account->name ?? ''}}</span></li>
        ...
        <ul class="list-unstyled my-3 py-1">
          ...
          <li class="d-flex align-items-center mb-4"><i class="ti ti-mail ti-lg"></i><span class="fw-medium mx-2">Email:</span> <span>{{$account->email ?? ''}}</span></li>
